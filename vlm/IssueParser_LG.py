...
SEARCHING_FILTER="http://vlm.lge.com/issue/issues/?jql=project%20%3D%20VWMEBICAS%20AND%20resolution%20%3D%20Unresolved%20And%20reporter%3D%20junho03.cho"
...
def export_excel():
    ...
    wb.save("ticket_external_LG.xlsx")
    wb.close()
...
def export_chart():
    ...
    wb.save("ICAS-3_Stability_Issue_LG.xlsx")
    wb.close()
